...
class ImageDB:
    ...
    def __init__ (self):
        self.image_df = pd.read_pickle('/Users/kirillovchinnikov/Documents/My_Projects/InstaGG/all_images_store.picklegz', 'gzip')
...
async def get_image(request):
    ...
    if len(request.app['image_dfs']) == 0:
        request.app['image_dfs'].append(ImageDB())
    
    imgByteData = None
    for image_id in req_ids:
        test_db_file = request.app['image_dfs'][0].return_file(image_id)
        print(test_db_file)
